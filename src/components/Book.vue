      ...
      <el-dialog
        ...
        <el-form :model="UpdateUserList" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <el-form-item label="书籍ID" >
            <el-input v-model="UpdateUserList.sort_id" disabled></el-input>
          </el-form-item>
          <el-form-item label="书籍名称" prop="sort_name" disabled>
            <el-input v-model="UpdateUserList.sort_name"></el-input>
          </el-form-item>
          <el-form-item label="分类" prop="sorthing">
            <el-input v-model="UpdateUserList.sorthing"></el-input>
          </el-form-item>
          <el-form-item label="简介" prop="sort_introduce">
            <el-input v-model="UpdateUserList.sort_introduce"></el-input>
          </el-form-item>
          <el-form-item label="内容" prop="sort_content">
            <el-input v-model="UpdateUserList.sort_content"></el-input>
          </el-form-item>
        </el-form>
    ...
    <el-button type="primary" @click="updateUser1">保 存</el-button>
      ...
      <el-dialog
        ...
        <el-form :model="AddUserList" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <!--          </el-form-item>-->
          <el-form-item label="书籍名称" prop="sort_name" disabled>
            <el-input v-model="AddUserList.sort_name"></el-input>
          </el-form-item>
          <el-form-item label="分类" prop="sorthing">
            <el-input v-model="AddUserList.sorthing"></el-input>
          </el-form-item>
          <el-form-item label="图片" prop="sort_picture">
            <el-input v-model="AddUserList.sort_picture"></el-input>
          </el-form-item>
          <el-form-item label="简介" prop="sort_introduce">
            <el-input v-model="AddUserList.sort_introduce"></el-input>
          </el-form-item>
          <el-form-item label="内容" prop="sort_content">
            <el-input v-model="AddUserList.sort_content"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    addUser1(){
      this.dialogAddUser = !this.dialogAddUser,
          this.$http.get("/Sortlistcontroller/addsortInfo", {
            params: {
              sort_name:this.AddUserList.sort_name,
              sorthing:this.AddUserList.sorthing,
              sort_introduce:this.AddUserList.sort_introduce,
              sort_content:this.AddUserList.sort_content,
              sort_picture:this.AddUserList.sort_picture,
            }
          }).then((res) => {
            console.log(res)
    ...
    //请求查看好文列表数据
    getUserList() {
      this.$http.get("/Sortlistcontroller/queryAllSort", {
        params: {
          page: this.page,
          limit: this.limit
        }
    ...
    updateUser1() {
      this.dialogUpdateUser = !this.dialogUpdateUser,
          this.$http.get("/Sortlistcontroller/updateSort", {
            params: {
              sortlist: this.UpdateUserList,
              sort_id:this.UpdateUserList.sort_id,
              sort_name:this.UpdateUserList.sort_name,
              sorthing:this.UpdateUserList.sorthing,
              sort_introduce:this.UpdateUserList.sort_introduce,
              sort_content:this.UpdateUserList.sort_content,
    ...
    deleteUser(row) {
      this.$confirm('此操作将永久删除该信息, 是否继续?', '提示', {
        ...
        this.$http.get("/Sortlistcontroller/deleteSortById", {
          params: {
            sort_id: row.sort_id,
          }
        }).then((res) => {
