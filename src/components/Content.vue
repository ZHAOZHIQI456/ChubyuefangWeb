...
<!--        </el-col>-->
      ...
      <el-dialog
        ...
        <el-form :model="UpdateUserList" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <el-form-item label="code" prop="wCode">
            <el-input v-model="UpdateUserList.wCode"></el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    updateUser1() {
      this.dialogUpdateUser = !this.dialogUpdateUser,
          this.$http.get("/Workscontroller/checkworkinfo", {
            params: {
              w_id:this.UpdateUserList.w_id,
              wCode:this.UpdateUserList.wCode,
