<template>
  <div>
    ...
    <el-breadcrumb style="padding-bottom:15px " separator="/">
      ...
      <el-breadcrumb-item>好文推送</el-breadcrumb-item>
    ...
    <el-card>
      ...
      <el-dialog
        ...
        <el-form :model="UpdateUserList" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <el-form-item label="好文ID">
            <el-input v-model="UpdateUserList.article_id" disabled></el-input>
          </el-form-item>
          <el-form-item label="好文名称" prop="article_name">
            <el-input v-model="UpdateUserList.article_name"></el-input>
          </el-form-item>
          <el-form-item label="简介" prop="article_part">
            <el-input v-model="UpdateUserList.article_part"></el-input>
          </el-form-item>
          <el-form-item label="文章内容" prop="article_content">
            <el-input v-model="UpdateUserList.article_content"></el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    //请求查看好文列表数据
    getUserList() {
      this.$http.get("/Articlecontroller/selectArticleInfos", {
        params: {
          page: this.page,
          limit: this.limit
        }
    ...
    updateUser1() {
      this.dialogUpdateUser = !this.dialogUpdateUser,
          this.$http.get("/Articlecontroller/updateArticle", {
            params: {
              Article: this.UpdateUserList,
              article_id:this.UpdateUserList.article_id,
              article_name:this.UpdateUserList.article_name,
              article_part:this.UpdateUserList.article_part,
              article_content:this.UpdateUserList.article_content,
    ...
    deleteUser(row) {
      this.$confirm('此操作将永久删除该信息, 是否继续?', '提示', {
        ...
        this.$http.get("/Articlecontroller/deleteArticleInfo", {
          params: {
