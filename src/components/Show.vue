  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="40" style="padding-bottom: 15px">
        ...
        <el-col :span="4">
          <el-button type="primary" size="mini" @click="addUser">添加好文</el-button>
        </el-col>
      ...
      <el-dialog
        ...
        <el-form :model="UpdateUserList" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <el-form-item label="轮播图ID">
            <el-input v-model="UpdateUserList.photoId" disabled></el-input>
          </el-form-item>
          <el-form-item label="图片内容" prop="photofile">
            <el-input v-model="UpdateUserList.photofile"></el-input>
          </el-form-item>
          <el-form-item label="图片类型" prop="ptype">
            <el-input v-model="UpdateUserList.ptype"></el-input>
          </el-form-item>
        </el-form>
    ...
    <el-button type="primary" @click="updateUser1">保 存</el-button>
      ...
      <el-dialog
        ...
        <el-form :model="AddUserList" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <!--          </el-form-item>-->
          <el-form-item label="图片内容" prop="photofile">
            <el-input v-model="AddUserList.photofile" ></el-input>
          </el-form-item>
          <el-form-item label="图片类型" prop="ptype">
            <el-input v-model="AddUserList.ptype" ></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    addUser1(){
      this.dialogAddUser = !this.dialogAddUser,
          this.$http.get("/Slideshowcontroller/insertnewpicture", {
            params: {
              photofile:this.AddUserList.photofile,
              pType:this.AddUserList.pType,
            }
          }).then((res) => {
            console.log(res)
    ...
    Search() {
      ...
      this.$http.get("/Slideshowcontroller/queryAllpicture", {
        params: {
          page: 1,
          limit: 10,
          Keyword: this.input3,
    ...
    updateUser1() {
      this.dialogUpdateUser = !this.dialogUpdateUser,
          this.$http.get("/Slideshowcontroller/updatepicture", {
            params: {
              photoId:this.UpdateUserList.photoId,
              photofile:this.UpdateUserList.photofile,
              pType:this.UpdateUserList.ptype,
    ...
    deleteUser(row) {
      this.$confirm('此操作将永久删除该信息, 是否继续?', '提示', {
        ...
        this.$http.get("/Slideshowcontroller/deletepicture", {
          params: {
            photoId: row.photoId,
          }
        }).then((res) => {
